...
export const STAGE_DEFINITIONS = [
  ...
  { id: 'mirror-corridor-v1', number: '04', title: '鏡越しの回廊', teaser: '隔離キーと格子の向こうに制御室がある。', contentVersion: 1, saveKey: 'chroma-rift.mirror-corridor.v1', discoveries: ['figure', 'mirror', 'ratchet'], targets: ['mirror-corridor-figure','mirror-corridor-key','mirror-corridor-mirror','mirror-corridor-practice','mirror-corridor-winch','mirror-corridor-exit'], renderKind: 'simple', binding: 'module', playerVisible: false },
