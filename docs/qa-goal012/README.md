...
| `route-optional.mp4` | 23.37 s | Bell A, closed manual shutter, south return and east detour, curtain and actual exit walk | Uses subdued intensity; direct-sight behavior under standard intensity needs device review. |
