...
自然成功動画SHA-256 `d418d2150f98534d57de3d5a8a109b18c6302821ab4b40facac72f6d94eb4266`。接触シート `2cf3583f7e8659b1bde7135352d546bafee9e330f9dbe02a9700fb140c6bacfb`。PNG抽出と接触シートを開いて観察窓内の身体・屋外床を確認したが、MP4の連続視聴は未実施。
...
復旧動画は390×844、10fps、365枚、simulation 30.02秒。最大46 draw calls/3,578 triangles、終了時geometries/textures 0、renderer 1、browser errors 0。動画SHA-256 `404f4bc6c6b4a4632ec6819d3ee448ab399ad52c7f6add0233893f409e2ef428`、接触シート `e9c6a462fb6354408cfb2823fd82e740bd48e78f19ee55e04d3775bbf50f0e4d`。接触シートと抽出した戻り・再収容・閉鎖のPNGを開いた。MP4の連続視聴、製品HUD・実音・native Canvas、端末での見え方・怖さ・FPS・発熱は未実施。区画外へ戻った位置はイベントログで検査しており、接触シートだけで位置を証明したものではない。
